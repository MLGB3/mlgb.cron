...
drop table if exists index_medieval_documents;

create table index_medieval_documents( 
...
alter table index_medieval_documents
add constraint foreign_document_group
foreign key ( document_group )
references index_medieval_doc_groups( doc_group_type_code );
